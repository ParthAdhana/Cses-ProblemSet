...
ll get_xor(ll node, ll node_low, ll node_high, ll query_low, ll query_high)// O(log N)
{
    ...
    return get_xor(2 * node, node_low, mid, query_low, query_high) ^ 
        get_xor(2 * node+1, mid+1 , node_high , query_low, query_high);
}
